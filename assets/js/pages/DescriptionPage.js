            ...
            <div>
                <div className={'part'}>
                    <p className="lead">
                        ...
                        и без сжатия. Для каждого сигнала в базе данных указано, какой из брейкпоинтов структурного
                        ...
                        (таблица <code>target</code>). На визуализации брейкпоинт расположен ровно по центру
